...
ssh-keygen -t ed25519 -f /etc/ssh/initrd/ssh_host_ed25519_key -N ""
chmod 600 /etc/ssh/initrd/ssh_host_ed25519_key
echo -e "\033[32mSSH host key generated at /etc/ssh/initrd/ssh_host_ed25519_key\033[0m"
...
echo -e "\033[34m$(cat /etc/ssh/sops/age_public_key.txt)\033[0m"
